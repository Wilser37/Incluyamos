# 🗺️ Incluyamos - Sistema de Mapeo Colaborativo de Espacios Accesibles
...
**Incluyamos** es un sistema colaborativo diseñado para ayudar a personas con discapacidad motora a encontrar espacios deportivos y recreativos accesibles. La plataforma combina mapeo interactivo, verificación comunitaria y gamificación para mantener información actualizada y confiable.

### 🎓 Contexto Académico

Este proyecto fue desarrollado con el objetivo de demostrar la implementación de una solución tecnológica inclusiva y centrada en el usuario.
...
- **Herramienta:** [https://www.glideapps.com/]
